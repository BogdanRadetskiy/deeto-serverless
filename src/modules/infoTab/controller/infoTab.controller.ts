...
export async function getInfotabsInfotabsIdHandler(event) {
  await loadSequelize();
...
export async function patchInfotabsInfotabsIdHandler(event) {
  await loadSequelize();
...
export async function deleteInfotabsInfotabsIdHandler(event) {
  await loadSequelize();
